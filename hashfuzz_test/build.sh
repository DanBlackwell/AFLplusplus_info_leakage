...
WRAP_FLAGS="-Wl,-wrap,printf -Wl,-wrap,fprintf -Wl,-wrap,vprintf -Wl,-wrap,vfprintf -Wl,-wrap,puts -Wl,-wrap,fputs -Wl,-wrap,fwrite"
../afl-clang-fast $WRAP_FLAGS write_wrappers/wrapper.o src/classify.o -lc -o classify

../afl-clang-fast src/classify.o -o classify
