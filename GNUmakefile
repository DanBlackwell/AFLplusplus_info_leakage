...
afl-fuzz: $(COMM_HDR) include/afl-fuzz.h $(wildcard include/lz4*.h) $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o | test_x86
